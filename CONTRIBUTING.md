...
To exercise the bridge without a Microsoft 365 account, start PwaDrop and `PwaDrop.DragHarness`, then drag the virtual source card to the physical target card.

## Pull requests

- Add tests for platform-neutral behavior.
- Run the harness for OLE changes and record the Windows build and browser version.
- Preserve internal New Outlook drag behavior.
